...
video_file_label = tk.Label(root, text="Video/Audio File:")
...
video_file_button = tk.Button(root, text="Browse", command=select_video_file)
...
model_path_button = tk.Button(root, text="Browse", command=select_model_path)
...
run_button = tk.Button(root, text="Run Transcription", command=run_transcription)
